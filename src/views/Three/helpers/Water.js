...
// import Water_flow2 from 'assets/textures/Water_2_M_Flow.jpg';
...
//         this.flowDirection = options.flowDirection || new THREE.Vector2( 1, 0 );
//         this.flowSpeed = options.flowSpeed || 0.03;
//         this.reflectivity = options.reflectivity || 0.02;
//         this.scale = options.scale || 1;
//         this.shader = options.shader || THREE.Water.WaterShader;
//         this.textureLoader = new THREE.TextureLoader();
//         this.flowMap = options.flowMap || undefined;
//         this.normalMap0 = options.normalMap0 || textureLoader.load(Water_flow1);
//         this.normalMap1 = options.normalMap1 || textureLoader.load(Water_flow2);
//         this.cycle = 0.15; // a cycle of a flow map phase
//         this.halfCycle = cycle * 0.5;
